...
################# Head circumference for gestational age (centile) #############

pdfLinkBoys<- "https://media.tghn.org/medialibrary/2017/03/GROW_Newborn-ct-boys_hc_Table.pdf"
...
##
pdfLinkGirls<- "https://media.tghn.org/medialibrary/2017/03/GROW_Newborn-ct-girls_hc_Table.pdf"

tempGirls <- pdftools::pdf_text(pdf = pdfLinkGirls)
tempGirls <- stringr::str_split(string = tempGirls, pattern = "\n")

## Page 1
temp1 <- tempGirls[[1]][9:43]
...
hc_gestage_term_centile <- tidyr::pivot_longer(data = p,
                                               cols = "3rd":"97th",
                                               names_to = "centile",
                                               values_to = "hc")

usethis::use_data(hc_gestage_term_centile, overwrite = TRUE, compress = "xz")

################# Head circumference for gestational age (z-score) #############

pdfLinkBoys<- "https://media.tghn.org/medialibrary/2017/03/GROW_Newborn-zs-boys_hc_Table.pdf"
...
##
pdfLinkGirls<- "https://media.tghn.org/medialibrary/2017/03/GROW_Newborn-zs-girls_hc_Table.pdf"
...
## create tidy format table
hc_gestage_term_sd <- tidyr::pivot_longer(data = p,
                                          cols = "-3SD":"3SD",
                                          names_to = "sd",
                                          values_to = "hc")

usethis::use_data(hc_gestage_term_sd, overwrite = TRUE, compress = "xz")
